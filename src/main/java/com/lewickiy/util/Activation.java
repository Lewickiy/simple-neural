 ...
 * Фунуция активации имеет цели:
 * - позволяет нейронной сети представить решения,
 *   которые не являются всего лишь линейным преобразованием.
 *   (если сама фунуция активации сама больше чем просто линейное преобразование)
 ...
 *
 * Популярным множеством фунуций активации являются сигмоидные функции.
 * Результатом сигмоидной фунуции всегда будет значение в диапазоне от 0.0 да 1.0
 */
